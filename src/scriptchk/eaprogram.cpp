...
scriptprog::COpcode scriptprog::cOpcodeTable[256] = 
{
	...
	{1,1,1,OP_MEMBER,"member access '%s'"},
	{2,1,1,OP_MEMBER,"member access '%s'"},
	{3,1,1,OP_MEMBER,"member access '%s'"},
	{4,1,1,OP_MEMBER,"member access '%s'"},
	{1,1,1,OP_SCOPE,"scope access '%s'"},
	{2,1,1,OP_SCOPE,"scope access '%s'"},
	{3,1,1,OP_SCOPE,"scope access '%s'"},
	{4,1,1,OP_SCOPE,"scope access '%s'"},
