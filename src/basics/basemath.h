...
#endif//!defined(HAVE_DECL_ACOSL)

#if !defined(HAVE_DECL_ASINF)
#if !defined(HAVE_ASINF)
inline float asinf(float x)								{ return (float)asin((double)x); }
#else
float asinf(float x);
#endif//!defined(HAVE_ASINF)
#endif//!defined(HAVE_DECL_ASINF)

#if !defined(HAVE_DECL_ASINL)
...
#endif//!defined(HAVE_DECL_ASINL)

#if !defined(HAVE_DECL_ATAN2F)
...
#endif//!defined(HAVE_DECL_ATAN2F)

#if !defined(HAVE_DECL_ATAN2L)
...
#endif//!defined(HAVE_DECL_ATAN2L)

#if !defined(HAVE_DECL_ATANF)
#if !defined(HAVE_ATANF)
inline float atanf(float x)								{ return (float)atan((double)x); }
#else
float atanf(float x);
#endif//!defined(HAVE_ATANF)
#endif//!defined(HAVE_DECL_ATANF)

#if !defined(HAVE_DECL_ATANL)
...
#endif//!defined(HAVE_DECL_ATANL)

#if !defined(HAVE_DECL_CEILF)
#if !defined(HAVE_CEILF)
inline float ceilf(float x)								{ return (float)ceil((double)x); }
#else
float ceilf(float x);
#endif//!defined(HAVE_CEILF)
#endif//!defined(HAVE_DECL_CEILF)

#if !defined(HAVE_DECL_CEILL)
...
#endif//!defined(HAVE_DECL_FABSL)

#if !defined(HAVE_DECL_FLOORF)
#if !defined(HAVE_FLOORF)
inline float floorf(float x)							{ return (float)floor((double)x); }
#else
float floorf(float x);
#endif//!defined(HAVE_FLOORF)
#endif//!defined(HAVE_DECL_FLOORF)

#if !defined(HAVE_DECL_FLOORL)
...
#endif//!defined(HAVE_DECL_FREXPL)
...
#endif//!defined(HAVE_DECL_HYPOTF)

#if !defined(HAVE_DECL_HYPOTL)
#if !defined(HAVE_HYPOTL)
inline long double hypotl(long double x, long double y)	{ return (long double)hypot((double)x, (double)y); }
#else
long double hypotl(long double x, long double y);
#endif//!defined(HAVE_HYPOTL)
#endif//!defined(HAVE_DECL_HYPOTL)

#if !defined(HAVE_DECL_LDEXPF)
...
#endif//!defined(HAVE_DECL_LDEXPF)

#if !defined(HAVE_DECL_LDEXPL)
...
#endif//!defined(HAVE_DECL_LDEXPL)

#if !defined(HAVE_DECL_LOG10F)
#if !defined(HAVE_LOG10F)
inline float log10f(float x)							{ return (float)log10((double)x); }
#else
float log10f(float x);
#endif//!defined(HAVE_LOG10F)
#endif//!defined(HAVE_DECL_LOG10F)

#if !defined(HAVE_DECL_LOG10L)
...
#endif//!defined(HAVE_DECL_MODFF)

#if !defined(HAVE_DECL_MODFL)
...
#endif//!defined(HAVE_DECL_MODFL)

#if !defined(HAVE_DECL_POWF)
#if !defined(HAVE_POWF)
inline float powf(float x, float y)						{ return (float)pow((double)x,(double)y); }
#else
float powf(float x, float y);
#endif//!defined(HAVE_POWF)
#endif//!defined(HAVE_DECL_POWF)

#if !defined(HAVE_DECL_POWL)
