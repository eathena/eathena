...
inline int mail_read(struct map_session_data &sd, uint32 message_id) 	{ return 0; }
inline int mail_delete(struct map_session_data &sd, uint32 message_id) 	{ return 0; }
