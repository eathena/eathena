...
void pc_resetidle(struct map_session_data *);
...
int pc_addgmitem(struct map_session_data*,struct item*,int);
...
int pc_gainexp_core(struct map_session_data*,int,int,int);
...
void pc_parse_loginscript(struct map_session_data*);
...
int pc_wornring(struct map_session_data*);
int pc_get_view_class(struct map_session_data*);
