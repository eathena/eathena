...
typedef enum 
{
	...
	MSG_THIS_ITEM_IS_NOT_AN_EQUIPMENT		=170,
	MSG_D___VOID							=171,
	...
	MSG_ACTUALY_IN_NIGHT_FOR_S				=233,
	MSG_AFTER_PERMANENT_DAYLIGHT			=234,
	MSG_ACTUALY_IN_DAYLIGHT_FOR_S			=235,
	...
	MSG_ACTUALLY_ITS_THE_NIGHT				=500,
