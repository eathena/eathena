...
protected:
	///////////////////////////////////////////////////////////////////////////
	// global data for sql
	MYSQL mysqldb_handle;
	// db access
	char mysqldb_ip[32];
	unsigned short mysqldb_port;
	char mysqldb_id[32];
	char mysqldb_pw[32];
	...
	bool mysql_SendQuery(MYSQL_RES*& sql_res, const char* q, size_t sz=0)
	{
	#ifdef DEBUG_SQL
		ShowSQL("%s\n", q);
	#endif
	...
	bool mysql_SendQuery(const char* q, size_t sz=0)
	{
	#ifdef DEBUG_SQL
		ShowSQL("%s\n", q);
	#endif
	...
	const char *escape_string(char *target, const char* source, size_t len)
	{
