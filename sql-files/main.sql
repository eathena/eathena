...
CREATE TABLE `char` (
  ...
  `max_hp` smallint(11) unsigned NOT NULL default '0',
  `hp` smallint(11) unsigned NOT NULL default '0',
  `max_sp` smallint(11) unsigned NOT NULL default '0',
  `sp` smallint(11) unsigned NOT NULL default '0',
  ...
  `pet_id` smallint(11) unsigned NOT NULL default '0',
