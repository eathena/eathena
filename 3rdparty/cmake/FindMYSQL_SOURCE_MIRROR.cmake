...
set( _url "http://dev.mysql.com/downloads/mysql/?current_os=src&version=5.5" )
...
if( _error EQUAL 0 )
	...
	if( _url MATCHES "^/downloads/.*$" )
		set( _url "http://dev.mysql.com${_url}" ) 
	endif()
	...
	if( _error EQUAL 0 )
		file( READ "${_file}" _html )
		string( REGEX MATCH "<a href=\"([^\"]*)\">(HTTP|FTP)</a>" MYSQL_SOURCE_MIRROR_URL "${_html}" ) # get first mirror (closest mirror according to GeoIP)
